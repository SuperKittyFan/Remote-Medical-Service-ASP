...
namespace 医院管理系统 {
    ...
    public class dsa : DataSet {
        ...
        protected dsa(SerializationInfo info, StreamingContext context) {
        ...
        public class _TableDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public _TableRow Add_TableRow(System.Byte[] myimdata, string 姓名, string 性别, string 出生年月, string 籍贯, string 种族, string 政治面貌, string 学历, string 职务, string 电话, string 邮箱, string 家庭地址) {
