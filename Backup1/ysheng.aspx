<%@ Page language="c#" Codebehind="ysheng.aspx.cs" AutoEventWireup="false" Inherits="医院管理系统.ysheng" %>
			...
			<TABLE id="Table3" height="0" cellSpacing="1" cellPadding="1" width="75%" align="center"
				...
				<TR>
					<TD align="center" style="HEIGHT: 26px"><FONT face="宋体">
							<asp:button id="Button8" runat="server" Width="60px" Text="返回主页"></asp:button><asp:button id="Button2" runat="server" Text="增加" Width="60px"></asp:button>
							<asp:button id="Button5" runat="server" Width="62px" Text="查找"></asp:button>
							<asp:button id="Button6" runat="server" Width="62px" Text="修改"></asp:button>
							<asp:Button id="Button3" runat="server" Width="56px" Text="删除"></asp:Button>
									...
									<TABLE id="Table2" style="WIDTH: 699px; HEIGHT: 34px" cellSpacing="1" cellPadding="1" width="699"
										...
										<TR>
											<TD align="center"><FONT face="宋体">
													...
													<asp:Button id="Button1" runat="server" Text="确定"></asp:Button><STRONG></STRONG></FONT></TD>
										</TR>
									</TABLE>
								</FONT>
							</asp:panel></FONT></TD>
								...
								<TABLE id="Table1" style="WIDTH: 702px; HEIGHT: 387px" cellSpacing="1" cellPadding="1"
									...
									<TR>
										<TD align="center" colSpan="3">
											<asp:Button id="Button7" runat="server" Text="提交"></asp:Button>
