...
namespace 医院管理系统 {
    ...
    public class myima : DataSet {
        ...
        protected myima(SerializationInfo info, StreamingContext context) {
        ...
        public class _TableDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public _TableRow Add_TableRow(string 姓名, string 性别, string 出生年月, string 籍贯, string 种族, string 政治面貌, string 学历, string 职务, string 电话, string 邮箱, string 家庭地址, System.Byte[] 照片) {
            ...
            private void InitClass() {
                this.columnnumber = new DataColumn("number", typeof(long), null, System.Data.MappingType.Element);
        ...
        public class _TableRow : DataRow {
            ...
            public System.Byte[] 照片 {
                get {
                    try {
                        return ((System.Byte[])(this[this.table_Table.照片Column]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("无法获取值，因为它是 DBNull。", e);
                    }
            ...
            public void Set照片Null() {
                this[this.table_Table.照片Column] = System.Convert.DBNull;
            }
        }
