<%@ Page language="c#" Codebehind="zhuce.aspx.cs" AutoEventWireup="True" Inherits="医院管理系统.zhuce" %>
							...
							<TABLE id="Table1" width="100%" height="0" borderColor="#330033" cellSpacing="1" cellPadding="1"
								...
								<TR>
									<TD align="center" colSpan="2">
										<asp:button id="Button1" runat="server" Width="42px" Text="注册" onclick="Button1_Click"></asp:button>&nbsp;&nbsp;
										<asp:button id="Button2" runat="server" Width="40px" Text="取消" OnClick="Button2_Click"></asp:button>&nbsp;&nbsp;
